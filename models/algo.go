...
type Algo struct {
	...
	Params            map[string]map[string]interface{} // Save the initial Params of the Algo, for logging purposes. This is used to check the params after running a genetic search.
