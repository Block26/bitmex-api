...
type Algo struct {
	...
	SharpeCalculationInterval int                    // The number of days which average sharpe calculations are based on.
	...
	LogCloudTest              bool                   // Exports last 1 day of backtest history to cloud db
...
type AlgoConfig struct {
	...
	SharpeCalculationInterval int
	DataLength                int
	StartingBalance           float64
	LogBacktest               bool
	LogCloudBacktest          bool
	LogStateHistory           bool
	Rebalance                 func(*Algo)
	SetupData                 func(*Algo)
	OnOrderUpdate             func(*Algo, []iex.Order)
	OnPositionUpdate          func(*Algo)
